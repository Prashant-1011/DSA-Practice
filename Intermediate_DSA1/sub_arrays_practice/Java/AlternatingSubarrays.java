...
// You have to tell all the indices of array A
// that can act as a center of 2 * B + 1 length 0-1 alternating subarray.
// A 0-1 alternating array is an array containing only 0's & 1's,
// and having no adjacent 0's or 1's. For e.g. arrays [0, 1, 0, 1], [1, 0] and [1] are 0-1
...
public class AlternatingSubarrays {
    public int[] alternating(int[] A, int B) {
    ...
    public static void main(String[] args) {
        int[] A = {1, 0, 1, 0, 1};
        int B = 1;
        AlternatingSubarrays obj = new AlternatingSubarrays();
        int[] result = obj.alternating(A, B);
